	...
	<div class="row page-titles mx-0 mb-3">
		<div class="col-sm-6 p-0">
			<div class="welcome-text">
				<h4>{{ __('common.comments') }}</h4>
				<span>{{ __('common.edit_comment') }}</span>
			</div>
		</div>
				...
				<div class="card h-auto">
					...
					<div class="card-body">
						<div class="row">
							...
							@php
								$blog = \App\Models\Blog::where('id', $comment->blog_id)->first();
							@endphp
							<p> {{ __('common.comment_s_blog') }} : <a class="fw-bold" href="{{ DzHelper::laraBlogLink($comment->blog_id) }}"> {{ $blog->title }}</a></p>
